...
"Anyon condensation" (or better, "gauging one-form symmetry". The reason is explained [here](https://arxiv.org/abs/2603.00245)) is a mathematical operation that relates different 3d topological quantum field theories (TQFTs).  When the condensed anyons are Abelian bosons, the effect on topological lines (equivalently, anyon types) is often described as a "three-step producure":
